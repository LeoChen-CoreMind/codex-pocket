...
import com.garfiec.librechat.feature.files.screen.WorkspaceFilePickerScreen
...
fun EntryProviderScope<NavKey>.filePickerEntries(
    ...
    entry<FilesPicker> { key ->
        val viewModel = koinViewModel<WorkspaceFilesViewModel>()
        WorkspaceFilePickerScreen(
            viewModel = viewModel,
