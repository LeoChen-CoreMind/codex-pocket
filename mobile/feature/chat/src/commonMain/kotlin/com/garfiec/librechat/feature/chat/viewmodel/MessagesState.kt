...
data class MessagesState(
    ...
    /** Live assistant parts in the exact order they were received. Tool completion replaces the
     *  matching part in place; it never moves the tool below later text. */
    val streamingTimeline: List<StreamingTimelinePart> = emptyList(),
    ...
    val remoteTurnActive: Boolean = false,
...
enum class StreamingPartType { TEXT, THINKING, TOOL }

@Immutable
data class StreamingTimelinePart(
    val id: String,
    val type: StreamingPartType,
    val text: String = "",
    val toolCall: ActiveToolCall? = null,
)
