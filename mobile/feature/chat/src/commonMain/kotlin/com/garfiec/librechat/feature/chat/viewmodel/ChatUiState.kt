...
data class ChatUiState(
    ...
    val bridgeOnline: Boolean get() = content.bridgeOnline
    val remoteTurnActive: Boolean get() = content.remoteTurnActive
    val remoteTurnId: String? get() = content.remoteTurnId
    ...
    val streamingTimeline: List<StreamingTimelinePart> get() = content.streamingTimeline
