...
data class ChatToolsPageParams(
    ...
    val codexMode: String = "default",
    val onCodexModeChange: (String) -> Unit = {},
    val codexReasoningEffort: String = "medium",
    val onCodexReasoningEffortChange: (String) -> Unit = {},
    val codexApprovalMode: String = "request",
    val onCodexApprovalModeChange: (String) -> Unit = {},
            ...
            AnimatedContent(
                ...
                when (currentPage) {
                    ChatOptionsPage.Options -> ChatToolsSheetContent(
                        ...
                        codexMode = tools.codexMode,
                        onCodexModeChange = tools.onCodexModeChange,
                        codexReasoningEffort = tools.codexReasoningEffort,
                        onCodexReasoningEffortChange = tools.onCodexReasoningEffortChange,
                        codexApprovalMode = tools.codexApprovalMode,
                        onCodexApprovalModeChange = tools.onCodexApprovalModeChange,
                        onDismiss = dismiss,
