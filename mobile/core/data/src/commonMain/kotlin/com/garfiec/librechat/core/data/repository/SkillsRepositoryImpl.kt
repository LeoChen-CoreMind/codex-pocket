...
class SkillsRepositoryImpl(
    ...
    override suspend fun exportSkill(
        id: String,
        onProgress: (receivedBytes: Long, totalBytes: Long?) -> Unit,
    ): Result<ByteArray> = safeApiCall { skillsApi.exportSkill(id, onProgress) }
    ...
    override suspend fun getSkillFileContent(
        skillId: String,
        relativePath: String,
    ): Result<SkillFileContentResponse> =
        safeApiCall { skillsApi.getSkillFileContent(skillId, relativePath) }
